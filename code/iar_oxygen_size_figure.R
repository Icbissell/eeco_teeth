...
legend("topright", legend = c("IODP 1553", "DSDP 596"), col = c(nieder.iar.col, dsdp.596.col), pch = 16, bty = "n", inset = c(0.05, 0.02))


### plot mean length

## Run the GAM - this is on neiderbockstruck et al ages
gam_5 <- gam(length~s(nieder_ages, k=5), data=teeth_total)
